...
namespace UCP1_PAW_047_C.Controllers
{
    public class AdminsController : Controller
    {
        ...
        public AdminsController(TheDrugsContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdAdmin,Nama")] Admin admin)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdAdmin,Nama")] Admin admin)
        {
            if (id != admin.IdAdmin)
            {
                return NotFound();
