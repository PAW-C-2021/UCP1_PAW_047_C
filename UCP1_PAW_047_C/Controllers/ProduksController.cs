...
namespace UCP1_PAW_047_C.Controllers
{
    public class ProduksController : Controller
    {
        ...
        public ProduksController(TheDrugsContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdProduk,Nama")] Produk produk)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdProduk,Nama")] Produk produk)
        {
